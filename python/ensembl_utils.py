...
#
##############################################################################
def GetInfo(base_url, ids, fout, verbose):
...
##############################################################################
def GetXrefs(base_url, ids, fout, verbose):
...
if __name__=='__main__':
  ...
  if args.op=='getInfo':
    GetInfo(BASE_URL, ids, fout, args.verbose)

  elif args.op=='getXrefs':
    GetXrefs(BASE_URL, ids, fout, args.verbose)
