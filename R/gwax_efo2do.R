...
setDT(efo_gwas)
message(sprintf("GWAS studies related by EFO-subclass: %d", 
...
message(sprintf("GWAS EFO_ID to DO_ID mappings (distance=1): EFO_IDs: %d, DO_IDs: %d", 
        uniqueN(efo2do_gwas[distance==1, efo_id]), uniqueN(efo2do_gwas[distance==1,
do_id])))
message(sprintf("GWAS EFO_ID to DO_ID mappings (distance=2): EFO_IDs: %d, DO_IDs: %d", 
        uniqueN(efo2do_gwas[distance==2, efo_id]), uniqueN(efo2do_gwas[distance==2,
do_id])))
