...
message(sprintf("snp2gene_FILE snp2gene pairs: %d", nrow(unique(snp2gene_file[, .(SNP, ENSG)]))))
...
setDT(snp2gene_api )
message(sprintf("File (%s) rows: %d", sub("^.*/", "", ifile_api), nrow(snp2gene_api)))
