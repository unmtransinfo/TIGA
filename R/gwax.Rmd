...
```{r}
setorder(t2g, mu_rank)
knitr::kable(t2g[(ok)][1:10][, .(gsymb, name, fam, tdl, n_study, study_N_mean, rcras, or_median, pvalue_mlog_median, mu_score, mu_rank)], caption=sprintf("GWAX: %s, top hits", query_trait))
```
