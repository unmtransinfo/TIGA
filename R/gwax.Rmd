...
inferred by some score?

To-do:

* Confidence scoring for SNP-gene mappings.
* EFO semantic subclass related studies, linking, aggregation, scoring.
...
* Implement multivariate non-parametric ranking via &mu; scores.
...
message(sprintf("Pareto_filter result: %d / %d", sum(t2g[, ok]), nrow(t2g)))
```
