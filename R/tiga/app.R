...
#	,wellPanel(uiOutput("clip"))
	...
	tabsetPanel(id="tabset", type="tabs",
		...
		tabPanel(value="downloads", title=HTML("<i><br/>Downloads</i>"),
			...
			HTML("For latest and archived files also see: <b><a href=\"https://unmtid-dbs.net/download/TIGA/\" target=\"_blank\">TIGA downloads directory</a></b>. For source files see <b><a href=\"https://ftp.ebi.ac.uk/pub/databases/gwas/releases\">GWAS Catalog releases directory</a></b>")
		),
