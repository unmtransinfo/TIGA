...
plot_ly(gwas_platforms_cast, x=~YEAR, y=~NR, name="Not Reported",
  ...
  layout(title = 'GWAS counts by year &amp; vendor',
         xaxis = list(title="", showgrid=F, range=c(2005, 2020), dtick=1, tickangle=45),
...
n_study=col_integer(), study_N_mean=col_integer(), n_snp=col_integer(), geneNtrait=col_integer(), traitNgene=col_integer(), pvalue_mlog_max=col_double(),
