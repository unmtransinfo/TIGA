...
ifile_efo2do <- "data/oxo_efo2doid.tsv"
...
n_study=col_integer(), study_N_mean=col_integer(), n_snp=col_integer(), n_traits_g=col_integer(), n_genes_t=col_integer(), pvalue_mlog_median=col_double(),
